...
GQL_AST_ENUM_PRINTER(SimpleNumericType,
                     ...
                     (UnsignedInteger8, "UNSIGNED INTEGER8"),
                     (UnsignedInteger16, "UNSIGNED INTEGER16"),
                     (UnsignedInteger32, "UNSIGNED INTEGER32"),
                     (UnsignedInteger64, "UNSIGNED INTEGER64"),
                     (UnsignedInteger128, "UNSIGNED INTEGER128"),
                     (UnsignedInteger256, "UNSIGNED INTEGER256"),
...
GQL_AST_ENUM_PRINTER(PrecisionNumericType::Type,
                     (Int, "INT"),
                     (UInt, "UINT"),
                     (Integer, "INTEGER"),
